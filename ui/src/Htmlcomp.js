...
export class Dateselect extends React.Component {
  ...
  render() {
    return <div id="dob-group" className="form-control nobgbd">
...
//   }
//   render() {
//     return <input type="text" name="mobile" ref={this.refMobile} className="form-control" placeholder="Mobile number" />
//   }
// }